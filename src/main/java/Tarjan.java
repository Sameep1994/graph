...
public class Tarjan {
    ...
    *Kosaraju needs two traversals
    *
    *1.All elements which starts recursion are pushed in a stack
    *
    * if all adjacent of vertex are done with recursion and
    * discovery[u]=lowtime[u] then print all other vertices in stack
    *
    *
    *
    *
